...
const client = new Client({
    intents: [
        ...
        GatewayIntentBits.MessageContent // Necessário para a IA ler a mensagem do usuário
    ]
});
...
function readSettings() {
    ...
    // Retorna o padrão da variável de ambiente se o arquivo não existir ou falhar
